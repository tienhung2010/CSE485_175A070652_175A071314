...
<body>
	<div class = "navbar navbar-default" align ="center" style="background-color:#888;   ">
		<img src = ""  height = "55px" /><span class = "navbar" style="color:#00000;font-weight: bold ; font-size:20px" >QUẢN LÝ WEBSITE</span>
	</div>
		...
		<div class = "panel panel-primary">
			...
			<div class = "panel-body">
				<form enctype = "multipart/form-data" action = "login_query.php" role = "form" method = "POST">
					...
					<div class = "form-group">
						<button class = "btn btn-block btn-outline-success" name = "login"> Đăng Nhập</button>
					</div>
				</form>
			</div>
		</div>	
	...
	<div id = "footer" >
		<label class = "footer-title">Quản lý đăng nhập tài khoản </label>
	</div>
</body>
<?php
	include("script.php");
